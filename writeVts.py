...
gridToVTK(
    ...
    y,
    z,
    pointData={"radius": r3D, "cyl_radius": s, "ugradu": (udu_x, udu_y, udu_z)},
)
...
gridToVTK(
    ...
    y,
    z,
    pointData={"radius": r3D, "cyl_radius": s, "coriolis force": (cor_x, cor_y, cor_z)},
)
...
gridToVTK(
    ...
    y,
    z,
    pointData={"radius": r3D, "cyl_radius": s, "pressure gradient": (dp_x, dp_y, dp_z)},
)
